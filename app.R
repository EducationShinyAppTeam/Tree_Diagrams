...
bank1 <- read.csv(file = "Context_Bank_L1.csv", 
                  header = TRUE, 
                  stringsAsFactors=FALSE) # Read in question bank 1
bank2 <- read.csv(file = "Context_Bank_L2.csv", 
                  header = TRUE, 
                  stringsAsFactors=FALSE) # Read in question bank 2
bank3 <- read.csv(file = "Context_Bank_L3.csv", 
                  header = TRUE, 
                  stringsAsFactors=FALSE) # Read in question bank 3
          ...
          sidebarLayout(
            sidebarPanel(
              ...
              fluidRow(
                column(
                  width = 10, 
                  numericInput(inputId = "exploreAns", 
              ...
              bsButton(inputId = "checkExplore", 
                       label = "Check Answer", 
                       size = "large"),
              bsButton(inputId = "nextStep", 
                       label = "Next Step", 
                       size = "large"),
              ...
              the probability of getting a positive test changes as the prevalence 
              moves away from 3%."), 
        ...
        tabItem(
          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              tags$ul(
                ...
                tags$li("Level 2: You will create the tree from scratch, 
                                ...
                                questions."), 
                tags$li("Level 3: You will develop a tree from 
              ...
              sidebarLayout(
                ...
                mainPanel(
                  ...
                  fluidRow(
                    div(id = "question1", 
                        column(width = 4, 
                               bsButton(inputId = "comboCheck1",
                                        label = "Check Answer", 
                                        size = "large") 
                        ), 
                        conditionalPanel(condition = "output.showAnsButton1", 
                                         column(width = 8, 
                                                bsButton(inputId = "showAns1", 
                                                         label = "Show Answer", 
                                                         size = "large"), 
                                                textOutput("answer1"))
                        ))), 
              ...
              sidebarLayout(
                sidebarPanel(
                  conditionalPanel(
                    ...
                    fluidRow(
                      ...
                      column(selectInput(inputId = "nchildA2", 
                                         label = "Children", 
                                         choices = c(2, 3), 
                                         width = '60px'), 
                             width = 4)
                    ...
                    p("Node B"), 
                    fluidRow(
                      column(uiOutput("lab22"), 
                             width = 8), 
                      column(selectInput(inputId = "nchildB2", 
                                         label = "Children", 
                                         choices = c(2, 3), 
                                         width = '60px'), 
                             width = 4)), 
                    p("Node C"), 
                    fluidRow(
                      column(uiOutput("lab32"), 
                             width = 8), 
                      column(selectInput(inputId = "nchildC2", 
                                         label = "Children", 
                                         choices = c(2, 3), 
                                         width = '60px'), 
                             width = 4)), 
                    ...
                    conditionalPanel(
                      ...
                      p("Node D"), 
                      fluidRow(
                        column(uiOutput("lab42"), 
                               width = 8), 
                        column(selectInput(inputId = "nchildD2", 
                                           label = "Children", 
                                           choices = c(2, 3), 
                                           width = '60px'), 
                               width = 4))
                    ), 
                    bsButton(inputId = "checkStep2", 
                             label = "Check Answer", 
                             size = "large"), 
                    bsButton(inputId = "skip", 
                             label = "Next Step", 
                             size = "large"), 
                    fluidRow(
                      column(width = 2, 
                ...
                mainPanel(
                  ...
                  conditionalPanel(
                    condition = "output.nextStep2", 
                    # Options for displaying probabilities and edge labels
                    checkboxInput(inputId = "displayProbs2",
                                  label = "Display Leaf Node Probabilities"), 
                    
                    # Plot tree
                    plotOutput("graph2"), 
                    htmlOutput("graph2Alt"),       
                    bsButton(inputId = "newQuestion2", 
                             label = "Next Question", 
                             size = "large"), 
                    ...
                    fluidRow(
                      column(width = 3, 
                             numericInput(inputId = "comboProb2", 
                                          label = "Enter Answer", 
                                          value = NA, 
                                          min = 0, 
                                          max = 1, 
            ...
            tabPanel(
              ...
              sidebarLayout(
                sidebarPanel(
                  checkboxInput(inputId = "shownChildOptions", 
                  ...
                  conditionalPanel(
                    ...
                    fluidRow(
                      column(paste("Options for node ", 
                                   nodeNames[1]), 
                             width = 8), 
                      column(selectInput(inputId = "nchildA3", 
                                         label = NULL, 
                                         choices = c(2, 3), 
                                         selected = 2, 
                                         width = '60px'), 
                    ...
                    fluidRow(
                      column(paste("Options for node ", 
                                   nodeNames[2]), 
                             width = 8), 
                      column(selectInput(inputId = "nchildB3", 
                                         label = NULL, 
                                         choices = c(0, 2, 3), 
                                         selected = 2,
                                         width = '60px'), 
                    ...
                    fluidRow(
                      column(paste("Options for node ", 
                                   nodeNames[3]), 
                             width = 8), 
                      column(selectInput(inputId = "nchildC3", 
                                         label = NULL, 
                                         choices = c(0, 2, 3), 
                                         selected = 2, 
                                         width = '60px'), 
                    ...
                    conditionalPanel(
                      ...
                      fluidRow(
                        column(paste("Options for node ", 
                                     nodeNames[4]), 
                               width = 8), 
                        column(selectInput(inputId = "nchildD3", 
                                           label = NULL, 
                                           choices = c(0, 2, 3), 
                                           selected = 2, 
                                           width = '60px'), 
                  ...
                  checkboxInput(inputId = "showLabelOptions", 
              ...
              input.nchildC3 == 3", 
                  ...
                  conditionalPanel(condition = "output.showLabelWarning", 
                                ...
                                graph. Consider using shorter labels.", 
                                     class = "redtext")), 
                  checkboxInput(inputId = "showWeightOptions", 
              ...
              input.nchildC3 == 3", 
                  ...
                  conditionalPanel(
                    ...
                    checkboxInput(inputId = "recursionOptions", 
              ...
              (input.nchildB3 == 0 || input.nchildC3 == 0))", 
                  ...
                  fluidRow(
                    column(width = 3, 
                           numericInput(inputId = "comboProb3", 
                                        label = "Enter Answer", 
                                        value = NA, 
                                        min = 0, 
                                        max = 1, 
                  ...
                  fluidRow(
                    div(id = "question3", 
                        ...
                        conditionalPanel(
                          ...
                          column(width = 2, 
                                 bsButton(inputId = "showHint3", 
                                          label = "Hint", 
                                          size = "large")
                          ), 
                          column(width = 7, 
                                 bsButton(inputId = "showAns3", 
                                          label = "Show Answer", 
                                          size = "large"), 
                                 textOutput("answer3")), 
                          br(), 
...
server <- function(input, output, session) {
  ...
  index <- reactiveValues(context1 = 1, 
                          question1 = 1, 
                          context2 = 1, 
                          question2 = 1, 
                          context3 = 1, 
                          question3 = 1)
  reset <- reactiveValues(weight = FALSE, 
                          question = FALSE, 
                          answer = FALSE, 
                          setUp2 = FALSE, 
                          setUpAns2 = FALSE, 
  ...
  output$posTest <- renderText({
    edgeLabels <- c(input$prevalence/100, 1-input$prevalence/100, 
                    .98, .02, .03, .97)
  ...
  output$falseN <- renderText({
    edgeLabels <- c(input$prevalence/100, 1-input$prevalence/100, 
                    .98, .02, .03, .97)
    pNeg <- round(x = edgeLabels[1]*edgeLabels[4]+edgeLabels[2]*edgeLabels[6], 
                  digits = 4)
    paste("Probability that a negative test is a false negative: ", 
          format(x = round(x = (edgeLabels[1]*edgeLabels[4])/pNeg, 
                           digits = 4), 
                 scientific = F))})
  ...
  output$falseP <- renderText({
    edgeLabels <- c(input$prevalence/100, 1-input$prevalence/100, 
                    .98, .02, .03, .97)
    pPos <- round(x = edgeLabels[1]*edgeLabels[3]+edgeLabels[2]*edgeLabels[5], 
                  digits = 4)
    paste("Probability that a positive test is a false positive: ", 
          format(x = round(x = 1-((edgeLabels[1]*edgeLabels[3])/pPos), 
                           digits = 4), 
                 scientific = F))})
  ...
  output$exploreProbPlot <- renderPlot({
    ...
    pPos <- round(x = edgeLabels[1]*edgeLabels[3]+edgeLabels[2]*edgeLabels[5], 
                  digits = 4)
    data <- data.frame(
      "Name" = c("p(positive test) ",
                 "p(false negative)",
                 "p(false positive) "),
      "Value" = c(edgeLabels[1]*edgeLabels[3]+edgeLabels[2]*edgeLabels[5],
                  round(x = (edgeLabels[1]*edgeLabels[4])/pNeg, 
                        digits = 4),
                  round(x = 1-((edgeLabels[1]*edgeLabels[3])/pPos), 
                        digits = 4)))
    ggplot(aes(x = Name, y = Value), data = data) +
      ggtitle("Test Probabilities") +
      geom_bar(stat = "identity") +
      geom_text(aes(label = format(x = Value, scientific = FALSE), 
                    y = Value + .06), 
  ...
  exploreDF <- reactive({
    ...
    probs <- format(x = round(x = probs, 
                              digits = 4), 
                    scientific = F)
    edgeLabels <- format(x = round(x = edgeLabels,
                                   digits = 2), 
                         scientific = F)
  ...
  output$exploreGraph <- renderPlot({
    ...
    plot(igraph::graph_from_data_frame(df, directed = F), 
         ...
         label.cex = 1.2,
         edge.label.cex = 1.2,
         vertex.color = rep(x = "#E69F0080", 
                            times = 6), # Assigns the correct color to all 6 nodes
         layout = igraph::layout_as_tree(igraph::graph_from_data_frame(df), 
                                         root = 1))})
  
  # Add either check or X when user checks their answer 
  # (ecp = Explore Correctness Pic)
  ...
  output$lab32 <- renderUI({
    selectInput("label32", label = "Label", 
                choices = c(bank2$label1[index$context2], 
                            bank2$label2[index$context2], 
                            bank2$label3[index$context2], 
                            bank2$label4[index$context2]))})
  output$lab42 <- renderUI({
    selectInput(inputId = "label42", 
                label = "Label", 
                choices = c(bank2$label1[index$context2], 
                            bank2$label2[index$context2], 
                            bank2$label3[index$context2], 
  ...
  feedback <- 
    eventReactive(input$checkStep2, {
        ...
        if(input$nchildA2 == 3 && input$nchildD2 == bank2$nCD[index$context2]){
          ...
          if(input$label12 == labels[bank2$correctLabel1[index$context2]] && 
            ...
            output$stepCheckPic <- renderUI({
              renderIcon(icon = "correct", 
                         html = TRUE, 
                         width = 30)})
            "Good Job! You are Correct! Click the Next Step button to proceed to
          ...
          # children at both levels
            ...
            if(input$label12 == labels[bank2$correctLabel2[index$context2]] && 
              ...
              output$stepCheckPic <- renderIcon(icon = "correct", 
                                                width = 30)
            ...
            this case."
              ...
              output$stepCheckPic <- renderIcon(icon = "incorrect", 
                                                width = 30)
  ...
  output$contNum1 <- renderUI({selectInput(inputId = "contextNum1",
                                           label = "Context number",
                                           choices = contNums1(),
                                           selectize = FALSE,
                                           width = "150px")})
  output$contNum2 <- renderUI({selectInput(inputId = "contextNum2",
                                           label = "Context number",
                                           choices = contNums2(),
                                           selectize = FALSE,
                                           width = "150px")})
  output$contNum3 <- renderUI({selectInput(inputId = "contextNum3",
                                           label = "Context number",
                                           choices = contNums3(),
                                           selectize = FALSE,
                                           width = "150px")})
  ...
  baseMatrix2 <- function(context, bank){
    ...
    matrix(c(rep(x = 1, times = length(goodNodes)), 
  ...
  baseMat21 <- reactive({
    ...
    baseMatrix2(context = index$context1, 
                bank = bank1)
  })
  ...
  baseMat22 <- reactive({
    # Figure out which nodes need to be included as labels in the size 2 matrix
    baseMatrix2(context = index$context2, 
                bank = bank2)
  })
  ...
  baseMat23 <- reactive({
    # Figure out which nodes need to be included as labels in the size 2 matrix
    baseMatrix2(index = index$context3, 
                bank = bank3)
  })
  ...
  baseMat31 <- reactive({
    ...
    baseMatrix3(context = index$context1, 
                bank = bank1)
  })
  # For level 2
  baseMat32 <- reactive({
    # Figure out which nodes should be included in matrix
    baseMatrix3(context = index$context2, 
                bank = bank2)
  })
  # For level 3
  baseMat33 <- reactive({
    # Figure out which nodes should be included in matrix
    baseMatrix3(context = index$context3, 
                bank = bank3)
  })
  ...
  irrelevantNodes1 <- reactive({
    badNodes(context = index$context1, 
             bank = bank1)
  })
  # For level 2
  irrelevantNodes2 <- reactive({
    badNodes(context = index$context2, 
             bank = bank2)
  })
  # For level 3
  irrelevantNodes3 <- reactive({
    badNodes(context = index$context3, 
             bank = bank3)
  })
  ...
  # For level 1
  leafNodes1 <- reactive({
    lNodes(context = index$context1, 
           bank = bank1)
  })
  # For level 2
  leafNodes2 <- reactive({
    lNodes(context = index$context2, 
           bank = bank2)
  })
  # For level 3
  leafNodes3 <- reactive({
    lNodes(context = index$context3, 
           bank = bank3)
  })
      ...
      if(nrow(probs)>= 3){
        ...
        if(ncol(probs) == 3){
          ...
          # Appends 0s for the fourth row if none exists
            ...
            else{weight <- c(weight, rep(x = 0, times = 3)) }
          }}
      }
      else{
  ...
  # For level 1
  weights1 <- reactive({
    w(probs = probabilities1())
  })
  # For level 2
  weights2 <- reactive({
    w(probs = probabilities2())
  })
  # For level 3
  weights3 <- reactive({
    w(probs = probabilities3())
  })
  ...
  output$uMat22 <- renderUI({
    if((bank2$nCA[index$context2] == 3 && bank2$nCB[index$context2] == 3 && 
      ...
      matrixInput(inputId = "probabilities22", 
                  value = baseMat22(), 
                  rows = list(names = TRUE), 
                  cols = list( names = TRUE), 
                  class = "numeric")}
  ...
  output$uMat31 <- renderUI({
    if(bank1$nCA[index$context1] == 2 && bank1$nCB[index$context1] == 2 && 
      ...
      matrixInput(inputId = "probabilities31", 
                  value = baseMat31(), 
                  rows = list(names = TRUE), 
                  cols = list( names = TRUE), 
                  class = "numeric")}
  ...
  output$uMat32 <- renderUI({
    if((bank2$nCA[index$context2] == 2 && bank2$nCB[index$context2] == 2 && 
      ...
      matrixInput(inputId = "probabilities32", 
                  value = baseMat32(), 
                  rows = list(names = TRUE), 
                  cols = list( names = TRUE), 
                  class = "numeric")}
  ...
  bMat23 <- function(numeric){
    ...
    if(length(goodNodes>0)){
      ...
      # Create a matrix where left probability is always 1 of the right size
      if(numeric){matrix(c(rep(x = 1, times = length(goodNodes)), 
                           rep(x = 0, times = length(goodNodes))), 
                         nrow = length(goodNodes), 
                         dimnames = list(goodNodes, c("Left", "Right")))}
      # Create a matrix defaulted to Lab 1 and Lab 2 for all labels
      else{
        matrix(rep(x = c("Lab 1", "Lab 2"), 
                   times = length(goodNodes)), 
               byrow = TRUE, 
               nrow = length(goodNodes), 
               dimnames = list(goodNodes, c("Left", "Right")))}
    }
  ...
  bMat33 <- function(numeric){
    ...
    if(length(goodNodes>0)){
      ...
      # if dealing with labels
        ...
        matrix(rep(x = c("Lab 1", "Lab 2", "Lab 3"), times = length(goodNodes)), 
               byrow = T, 
               nrow = length(goodNodes), 
               dimnames = list(goodNodes, c("Left", "Center", "Right")))}
    }
  ...
  output$uMat33 <- renderUI({
    if(!is.null(bMat33(numeric = TRUE))){
      matrixInput(inputId = "probabilities33", 
  ...
  output$labelMat33 <- renderUI({
    if(!is.null(bMat33(numeric = FALSE))){
      matrixInput(inputId = "uEdgeLabels33", 
  ...
  output$labelMat23 <- renderUI({
    if(!is.null(bMat23(numeric = FALSE))){
      matrixInput(inputId = "uEdgeLabels23", 
  ...
  output$uGMat1 <- renderUI({
    matrixInput(
      ...
      value = matrix(rep(x = 0, times = length(leafNodes1())), 
  ...
  output$uGMat2 <- renderUI({
    matrixInput(
      ...
      value = matrix(rep(x = 0, times = length(leafNodes2())), 
  ...
  output$uGMat3 <- renderUI({
    matrixInput(
      ...
      value = matrix(rep(x = 0, times = length(leafNodes3())), 
  ...
  isValidInput1 <- reactive({
    validInput(context = index$context1, 
  ...
  isValidInput3 <- reactive({
    validInput(context = index$context3, 
               probs = probabilities3(), 
               bank = bank3)
  })
  ...
  makeGraphDataFrame1 <- reactive({
    graphDF(context = index$context1, 
            bank = bank1, 
  ...
  makeGraphDataFrame2 <- reactive({
    graphDF(context = index$context2, 
            bank = bank2, 
  ...
  makeGraphDataFrame3 <- reactive({
    ...
    weight <- w(probs = probabilities3(numeric = TRUE), 
                numeric = TRUE)
  ...
  layout1 <- reactive({
    layout_as_tree(graph = graph_from_data_frame(makeGraphDataFrame1()), 
                   root = 1)})
  layout2 <- reactive({
    layout_as_tree(graph = graph_from_data_frame(makeGraphDataFrame2()), 
                   root = 1)})
  layout3 <- reactive({
    layout_as_tree(graph = graph_from_data_frame(makeGraphDataFrame3()), 
                   root = 1)})
  ...
  graph <- function(df, bank, context, layout, showProbs = TRUE, colors = NULL){
    ...
    if(is.null(colors)){colors <- rep(x = "#E69F0080", 
                                      times = length(c(1, goodLabels)))}
  ...
  output$graph3 <- renderPlot({
    ...
    edgeLabels <- w(probs = probabilities3(numeric = FALSE), 
                    numeric = FALSE) 
  ...
  output$tempGraph2 <- renderPlot({
    ...
    plot(graph_from_data_frame(df, directed = F), 
         ...
         layout = layout_as_tree(graph = graph_from_data_frame(df), 
                                 root = 1), 
         asp = .2, 
         vertex.size = 8)
  })
  ...
  isCorrect1 <- eventReactive(input$checkMat1, {
    reset$weight <- TRUE
    correct(context = index$context1, 
            bank = bank1, 
            probs = probabilities1())
  })
  # For Level 2
  isCorrect2 <- eventReactive(input$checkMat2, {
    reset$weight <- TRUE
    correct(context = index$context2, 
            bank = bank2, 
            probs = probabilities2())
  })
  # For Level 3
  ...
  output$correctnessPic1 <- renderUI({
    if(isCorrect1()){
      ...
      if(reset$weight){renderIcon(icon = "incorrect", 
                                  html = TRUE, 
                                  width = 30)
      }
    }
  ...
  correctProbabilities1 <- reactive({
    cProbs(weights = weights1(), 
           probabilities = probabilities1(), 
           leafNodes =leafNodes1())
  })
  # For Level 2
  correctProbabilities2 <- reactive({
    cProbs(weights = weights2(), 
           probabilities = probabilities2(), 
           leafNodes = leafNodes2())
  })
  # For Level 3
  correctProbabilities3 <- reactive({
    cProbs(weights = weights3(), 
  ...
  cPic <- function(correct){
    if(correct){
      if(reset$question){renderIcon(icon = "correct", 
                                    html = TRUE)}
      else{NULL}
    }
    else{
      if(reset$question){renderIcon(icon = "incorrect", 
                                    html = TRUE, 
                                    width = 30)}
      else{NULL}
    }
  ...
  observeEvent(input$newContext3, {
    ...
    output$uMat23 <- renderUI({
      if(is.null(bMat23(numeric = TRUE)) || 
        ...
        matrixInput(inputId = "probabilities23", 
                    value = bMat23(numeric = TRUE), 
                    rows = list(names = TRUE), 
                    cols = list( names = TRUE), 
                    class = "numeric")}
  ...
  output$sampleAns3 <- renderPlot({
    ...
    if(bank3$Recursive[index$context3]){ # if in recursive case
      ...
      for(x in 42:50){ # For each potential leaf
        if(bank3[index$context3, x] == "A"){ # If recurses to A
          ...
          # Change D's color
          colors[
            grep(colnames(bank3)[x], 
                 nodeNames[c(1, goodLabels+1)])] <- "#D55E0080" 
          colors[grep("D", 
                      nodeNames[c(1, goodLabels+1)])] <- "#D55E0080" # Change D's color
    ...
    # If probabilities are right too, include leaf node probabilities
      ...
      weightIndex <- 1
      pasteAtEnd <- c()
      probs <- correctProbabilities3()[order(rownames(correctProbabilities3())), 
                                       1]
